...
<c:set var="pageTitle" value="Cập nhật loại sản phẩm"/>
<jsp:include page="/jsp/common/header.jsp"/>
<jsp:include page="/jsp/common/sidebar.jsp"/>
<div class="container-fluid">
    <div class="mt-4">
        <h2>Cập nhật loại sản phẩm may</h2>
        <form action="" method="post" id="productTypeForm" class="mt-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="code" class="form-control" value="${productType.code}">
            </div>
            <div class="mb-3">
                ...
                <div id="mtTags">
                    <c:forEach var="mt" items="${measurementTypes}">
                        <span class="mt-tag ${selectedIds.contains(mt.id)?'selected':''}" data-id="${mt.id}" data-body="${mt.bodyPart}">${mt.name}</span>
                    </c:forEach>
                </div>
            </div>
            <div class="mb-3">
